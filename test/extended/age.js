...
import {inputValues4, clearInput, inputNameGenderStory} from '../../helpers/methods';
...
describe('Age field suit', function () {
    ...
    describe('Placeholder', function () {
        ...
        it('TC-060 Age field placeholder = "Hero\'s age"', function () {
            ...
            expect(placeholder).toEqual(exp.agePlaceholderName);
        });
    });
    ...
    describe('Negative cases', function () {
        ...
        // it.only('TC-076a Age field contains one digit: "0" error=looks like unreal age', function () {
        //     $(sel.age).setValue(age.digitsNegative);
        //     let error = $(sel.error).getHTML('innerHTML');
        //     expect(error).toHaveText(exp.ageError);
        // });
        ...
        it('TC-085 Age field\'s spin up after 12 digit\'s number', function () {
            $(sel.age).setValue(age.digits12);
            $(sel.ageSpinUp).click();
            let error = $(sel.error).waitForDisplayed(2000);
            expect(error).toEqual(true);
